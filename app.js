...
function initOnboarding(){
  ...
  el.innerHTML='<style>.ob-modal{background:#fff;border-radius:20px;width:100%;max-width:460px;overflow:hidden}.ob-hero{background:#4f6ef7;padding:26px 24px 20px;text-align:center}.ob-kicker{font-size:12px;color:rgba(255,255,255,.5);margin-bottom:9px}.ob-big{font-size:27px;font-weight:500;color:#fff;line-height:1.3;margin-bottom:8px}.ob-big em{color:#fff;font-style:normal}.ob-caption{font-size:13px;color:rgba(255,255,255,.45)}.ob-body{padding:16px 18px 10px}.ob-compare{display:grid;grid-template-columns:1fr 1fr;gap:10px}.ob-col{border-radius:12px;overflow:hidden}.ob-ch{padding:9px 10px;font-size:12px;font-weight:500;text-align:center}.ob-before .ob-ch{background:#F2F2F0;color:#aaa}.ob-after .ob-ch{background:#4f6ef7;color:#fff}.ob-cb{padding:11px;background:#F8F8F6;display:flex;flex-direction:column;gap:8px}.ob-after .ob-cb{background:#EEF4FF}.ob-row{font-size:12px;padding-left:13px;position:relative;line-height:1.5}.ob-row::before{content:"";position:absolute;left:0;top:7px;width:5px;height:5px;border-radius:50%}.ob-bad{color:#ccc;text-decoration:line-through}.ob-bad::before{background:#E24B4A}.ob-good{color:#4f6ef7;font-weight:500}.ob-good::before{background:#4f6ef7}.ob-hl{background:#4f6ef7;border-radius:10px;padding:10px 12px;display:flex;align-items:center;gap:10px;margin-bottom:8px}.ob-hl-num{font-size:26px;font-weight:500;color:#fff;flex-shrink:0;line-height:1}.ob-hl-t{font-size:12px;font-weight:500;color:#fff}.ob-hl-s{font-size:10px;color:rgba(255,255,255,.6);margin-top:2px}.ob-notif{border-radius:10px;border:0.5px solid rgba(0,0,0,.1);overflow:hidden;margin-bottom:8px}.ob-nbar{background:#F2F2F0;padding:5px 10px;display:flex;align-items:center;gap:3px}.ob-nbd{width:6px;height:6px;border-radius:50%;display:inline-block}.ob-nbody{padding:8px 12px;display:flex;align-items:center;gap:8px}.ob-nt{font-size:12px;font-weight:500;color:#111}.ob-ns{font-size:10px;color:#888;margin-top:2px}.ob-foot{padding:12px 18px 20px}.ob-dots{display:flex;justify-content:center;gap:6px;margin-bottom:14px}.ob-dot{width:5px;height:5px;border-radius:50%;background:#D3D1C7;display:inline-block;cursor:pointer;transition:all .2s}.ob-dot.on{background:#4f6ef7;width:20px;border-radius:3px}.ob-brow{display:flex;gap:7px}.ob-bs{flex:1;padding:12px;font-size:13px;border:0.5px solid #ddd;border-radius:10px;background:transparent;color:#aaa;cursor:pointer}.ob-bn{flex:2;padding:12px;font-size:14px;font-weight:500;background:#4f6ef7;color:#fff;border:none;border-radius:10px;cursor:pointer}</style>'
